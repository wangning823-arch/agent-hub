...
export default function NewSessionModal({ agents, onCreate, onClose, preselectedProject }) {
  const [projects, setProjects] = useState([])
  const [selectedProject, setSelectedProject] = useState(preselectedProject || null)
